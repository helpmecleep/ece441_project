...
set_property PACKAGE_PIN W13 [get_ports { replay_video }]				
	set_property IOSTANDARD LVCMOS33 [get_ports { replay_video }]
set_property PACKAGE_PIN V2 [get_ports { text_or_graphics_mode }]					
	set_property IOSTANDARD LVCMOS33 [get_ports { text_or_graphics_mode }]
set_property PACKAGE_PIN T3 [get_ports { camera_refresh_rate }]					
	set_property IOSTANDARD LVCMOS33 [get_ports { camera_refresh_rate }]
set_property PACKAGE_PIN T2 [get_ports { ov7670_drive[0] }]					
	set_property IOSTANDARD LVCMOS33 [get_ports { ov7670_drive[0] }]
set_property PACKAGE_PIN R3 [get_ports { ov7670_drive[1] }]			
