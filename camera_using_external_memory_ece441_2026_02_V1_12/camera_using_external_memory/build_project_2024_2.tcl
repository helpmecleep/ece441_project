...
cd ..
create_project camera_using_external_memory $ProjectDirectory  -part xc7a100tcsg324-1
cd $ProjectDirectory

# ./camera_using_external_memory
...
add_files -norecurse {./i2c_sender.vhd ./histogram.vhd ./ov7670_registers.vhd ./ov7670_controller.vhd ./effects/rgb_to_gray.vhd ./video_timing.vhd ./camera.vhd ./ov7670_capture.vhd ./debouncer.vhd ./video.vhd ./led_display.vhd}
...
create_ip -name mig_7series -vendor xilinx.com -library ip -version 4.2 -module_name ddr
